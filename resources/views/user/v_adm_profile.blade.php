...
<div class="card">
    <div class="xtabledm">
        ...
        <form method="POST" action="{{route('profil.admin.edit')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
             <div class="col col-md-4 col-12 mt-4">
                ...
                <div class="col col-12 col-md-12">
                    ...
                    <input onchange="readURL(this);" class="form-control @error('foto') is-invalid @enderror" type="file" id="filefotopengguna" name="foto" hidden>
                    @error('foto')
            ...
            <div class="col col-md-8 col-12 mt-4">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_identitas" id="" class="form-control">
