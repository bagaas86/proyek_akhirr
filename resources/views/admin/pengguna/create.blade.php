                    ...
                    <div class="row">
                        <div class="col col-md-12 col-12">
                            <div class="form-group">
                                <label for="nama_barang">Nama Pengguna</label><small
                        ...
                        <div class="col col-md-7 col-12">
                            <div class="form-group">
                                <label for="nama_barang">Akun Terdaftar</label><small
                                    style="color:red;font-size:12px">*</small>
                                <input type="number" class="form-control @error('username') is-invalid @enderror"
                                    id="username" name="username" placeholder="NIP/NIK/NIM" value="{{ old('username') }}">
                                @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col col-md-5 col-12">
                            <div class="form-group">
                                <label for="password">Password</label><small style="color:red;font-size:12px">*</small>
                        ...
                        <div class="col col-md-3 col-12">
                            <div class="form-group">
                                <label for="level">Unit</label><small style="color:red;font-size:12px">*</small>
                                <select id="select2" class="select2-container @error('sebagai') is-invalid @enderror"
                                    name="sebagai">
