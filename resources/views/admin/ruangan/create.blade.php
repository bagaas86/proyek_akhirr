                ...
                <div class="row">
                    <div class="col col-md-6 col-12">
                        <div class="form-group">
                            <label for="nama_item">Nama Ruangan</label>
                            <input type="text" class="form-control @error('nama_item') is-invalid @enderror" id="nama_item" name="nama_item" placeholder="Masukkan Nama Ruangan" value="{{old('nama_item')}}">
                            @error('nama_item')
