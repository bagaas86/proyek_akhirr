<center>
    <div style="text-align: center" class="row">
        ...
        @if($approval->jenis_peminjaman == "Kendaraan" OR $approval->jenis_peminjaman == "Barang,Kendaraan" OR $approval->jenis_peminjaman == "Kendaraan,Ruangan" OR $approval->jenis_peminjaman == "Kendaraan,Supir" )
        ...
        @if($approval->jenis_peminjaman == "Kendaraan,Supir")
        <div class="col col-md-4 col-6">
            <div class="card-header h-50">
                <img src="{{asset('foto/dm/pengguna/default.png')}}" class="img-rounded" style="width:50%">
