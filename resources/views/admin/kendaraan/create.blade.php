                    ...
                    <div class="row">
                        <div class="col col-md-7 col-12">
                            <div class="form-group">
                                <label for="nama_barang">Merk Kendaraan</label><small
                        ...
                        <div class="col col-md-5 col-12">
                            <div class="form-group">
                                <label for="level">Tipe Kendaraan</label><small
                                    style="color:red;font-size:12px">*</small>
                                <select name="tipe_kendaraan"
                                    ...
                                    <option value="Kendaraan Bermotor Roda 4"
                                        @if (old('tipe_kendaraan') == 'Kendaraan Bermotor Roda 4') selected @endif>Kendaraan Bermotor Roda 4</option>
                                    <option value="Kendaraan Bermotor Roda 2"
                                        @if (old('tipe_kendaraan') == 'Kendaraan Bermotor Roda 2') selected @endif>Kendaraan Bermotor Roda 2</option>
                        ...
                        <div class="col col-md-7 col-12">
                            <div class="form-group">
                                <label for="nama_barang">Warna Kendaraan</label><small
                                    style="color:red;font-size:12px">*</small>
                        ...
                        <div class="col col-md-2 col-12">
                            <div class="form-group">
                                <label for="password">Plat Nomor</label><small style="color:red;font-size:12px">*</small>
                        ...
                        <div class="col col-md-3 col-12">
                            <div class="form-group">
                                <label for="level">Kondisi Kendaraan</label><small
                                    style="color:red;font-size:12px">*</small>
                        ...
                        <div class="col col-md-12 col-12">
                            <div class="form-group">
                                <label for="password">Informasi Tambahan</label><small
                                    style="color:red;font-size:12px">*</small>
