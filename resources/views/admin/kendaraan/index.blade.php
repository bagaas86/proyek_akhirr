            ...
            <tbody>
             @foreach($item as $data)
                <tr>
                    ...
                    <td style="width:10%"><img src="{{asset('foto/dm/kendaraan/'. $data->foto_item)}}" class="img-rounded" style="width:50%" alt=""></td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    <img src="{{asset('foto/dm/kendaraan/'. $data->foto_item)}}" style="width:25%" alt="">
                </center>
                <hr>
                <p class="mb-0" id="page">Apakah Anda Yakin Menghapus Kendaraan <b>{{$data->nama_item}}</b>?</p>
            </div>
            <div id="modalFooter" class="modal-footer">
                <a style="color:white" class="btn  btn-secondary" data-dismiss="modal">Tutup</a>
                <a style="color:white" href="{{route('dm.kendaraan.destroy', $data->id_item)}}" class="btn  btn-primary">Hapus</a>
            </div>
        </div>
    </div>
</div>
